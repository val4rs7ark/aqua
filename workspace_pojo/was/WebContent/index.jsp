...
<!DOCTYPE html>
<%
List<Map<String,Object>> wasLoginList =
	(List<Map<String,Object>>)request.getAttribute("wasLogin");
	String emp_name = null;
	if(wasLoginList!=null){
		Map<String,Object> rMap = wasLoginList.get(0);
...
<div class="container">
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			...
			<div class="card-body">
				<form action="/erp/wasLogin.was" method="post">

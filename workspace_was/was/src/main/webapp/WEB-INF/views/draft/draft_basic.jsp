...
<!--          <input type="hidden" id="hd_title" name="hd_title"> -->
         ...
         <div style="width:766px;height:830px;padding-left:0px;padding-right:0px;text-align:center;margin-left:10px;">
            <h1>기 안 서<span style="font-size:30px">(기본)</span></h1>
         <table style="height:780px;margin-right:100px;" border="1px solid"> 
               <tbody style="text-align:center;font-size:15px;">            
                  <tr style="height:35px;">
                     <td style="height:42px;background:#dee2e6">&nbsp;문&nbsp;서&nbsp;종&nbsp;류&nbsp;</td>
                     <td style=""><input name="draft_kind" type="text" value="공통-기안서(기본)" style="border:none;outline:none;text-align:center" onfocus="this.blur()"></td>
                     <td style="" rowspan="3">
                        <table style="table-layout:fixed;height:100%;width:500px" frame="void" border="1px solid red">
                           <tr style="height:25%">
                              <td rowspan="3" style="background:#dee2e6">&nbsp;결&nbsp;재&nbsp;</td>
                              <td style="">
                                 <input type="text" id="team_name_1" name="team_name_1" style="border:none;width:100%;text-align: center" value="">
                                 <input type="hidden" id="first_permission" name="first_permission" value="">
                              </td>
                              <td style="">
                                 <input type="text" id="team_name_2" name="team_name_2" style="border: none;text-align: center;width:100%" value="">
                                 <input type="hidden" id="seccond_permission" name="seccond_permission" value="">
                              </td>
                              <td style="">
                                 <input type="text" id="team_name_3" name="team_name_3" style="border: none;text-align: center;width:100%" value="">
                                 <input type="hidden" id="third_permission" name="third_permission" value="">
                              </td>
                              <td style="">
                                 <input type="text" id="team_name_4" name="team_name_4" style="border: none;text-align: center;width:100%" value="">
                           ...
                           <tr style="height:50%">
                              ...
                              <td>
                                 <input type="text" id="emp_name_2" name="emp_name_2" style="border: none;text-align: center;width:100%" value="">
                              </td>
                              <td>
                                 <input type="text" id="emp_name_3" name="emp_name_3" style="border: none;text-align: center;width:100%" value="">
                              </td>
                              <td>
                                 <input type="text" id="emp_name_4" name="emp_name_4" style="border: none;text-align: center;width:100%" value="">
                              </td>
                           </tr>
                           <tr style="height:25%">
                              <td>
                                 <input type="text" id="access_1" name="access_1" style="border: none;text-align: center;width:100%" value="">
                              </td>
                              <td>
                                 <input type="text" id="access_2" name="access_2" style="border: none;text-align: center;width:100%" value="">
                              </td>
                              <td>
                                 <input type="text" id="access_3" name="access_3" style="border: none;text-align: center;width:100%" value="">
                              </td>
                              <td>
                                 <input type="text" id="access_4" name="access_4" style="border: none;text-align: center;width:100%" value="">
                              </td>
                           </tr>
                        </table>
                     </td>
                  ...
                  <tr style="height:35px;">
                     ...
                     <td style="text-align:left;padding-left: 12px;" colspan="2"><input name="db_title" id="db_title" style="width:100%;border:none" type="text"></td>
                  </tr>                                                                                                  
                  <tr style="height:35px;">
                     <td colspan="3">      
                     <div>
                        <textarea name="ir1" id="ir1" rows="24" cols="104">
                        </textarea>   
                     </div>                   
                     </td>
               	  </tr>           

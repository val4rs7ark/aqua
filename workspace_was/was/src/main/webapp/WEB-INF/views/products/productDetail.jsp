...
<div class="row">
  ...
  <!-- ========================================================================================================================================
        ...
        ======================================================================================================================================== -->
         <div class="col-md-3">
              <table class="table table-hover" style="width: 345px; margin-top: 43px; margin-left: -69px;">
                <thead">
                  <tr>
                ...
                <tr>
                    <td style="width:20%; color:black; font-size:17px; text-align:center;"><strong>수량/무게</strong></td>
                    <td>
                       <input class="form-control" style="width:180px; color:black; font-size:17px;text-align:center;"

...
<div class="row">
  ...
  <div style="width:78%;margin-left: 35px;    padding-right: 83px; ">
  
  <!-- ======================================================================================================================================
                                                  생산품 상세검색 영역 시작
        ======================================================================================================================================= -->
  <form id="tb_Search">
  <div class="card bg-dark text-white" style="height:50px; margin-top: 52px;">
    	<div class="card-body" style="font-size: 17px; font-weight: 900; ">생산/품질관리 > 생산품 조회/등록</div>
  	</div>
     <div class="row">
   </div>  

...
%> 
  ...
  <!-- =======================================생산품 상세보기 영역================================= -->
  	<div class="col-sm-6" style="margin-top: 35px;">
  		...
  		<table id="pro_Detail"class="table" style="width:700px;height:180px;margin-top: 81.5px;" data-options="multiSelect:'true',toolbar:'#productDetail,#add'">
			  <tr>

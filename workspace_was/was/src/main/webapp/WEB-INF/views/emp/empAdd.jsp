 ...
 <div class="card bg-dark text-white" style="height:50px;margin-top: 20px;">
  ...
  <table class="table table-striped">
	<tr>
		...
		<td align="left" style="width:15%;padding-top:7px; padding-bottom:7px;">
			<input type="text" class="form-control" style="width:180px;" placeholder="전화번호" name="emp_hp">
		</td>
	</tr>
	<tr>
		...
		<td style="padding-top: 6px; padding-bottom: 6px;"> 
			<select name="emp_mili" class="custom-select" style="width:80%">
	...
	<tr>
		<td colspan="4" align="right">
			...
			<button class="btn btn-dark" onclick="javascript:addAction()">저장</button>
		</td>
	</tr>
  </table>
  </form>

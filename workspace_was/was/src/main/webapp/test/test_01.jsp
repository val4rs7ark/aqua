				...
				<!--================================공통코드로 추가할 추가 상단바===========================================-->
					...
					<!--================================상단바===========================================-->
						...
						<div class="container" style="margin-left: 0px; margin-right: 0px;">
							<div class="row" style="margin-top:10px; width:1340px;">
								<div class="col" style="padding-left: 5px; padding-right: 5px;"> 
									<ul class="nav nav-tabs">
										<li class="nav-item">
											<a class="nav-link active" data-toggle="tab" href="#qwe" style="padding-top: 2px;padding-bottom: 2px;font-size: 13px; font-weight: 700;">미결제 문서</a>
										</li>
										<li class="nav-item">
											<a class="nav-link " data-toggle="tab" href="#asd" style="padding-top: 2px;padding-bottom: 2px;font-size: 13px; font-weight: 700;">결제완료 문서</a>
										</li> 
									</ul>
